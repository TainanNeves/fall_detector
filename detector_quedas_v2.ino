...
/*
void detectaQueda(int magnitudeBase, int magnitudeMedida){
...
void loop(){
  ...
  float magnitude=sqrt(pow(AcX, 2)+pow(AcY, 2)+pow(AcZ, 2));     //Define a magnitude da queda não importando a direção
  ...
  delay(500);
  //detectaQueda(100000, magnitude); //Faz a detecção de queda e primeiro aviso
}
